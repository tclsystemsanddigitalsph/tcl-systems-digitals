  ...
  return (
    <main className="store-admin-dashboard">
      <div className="store-admin-dashboard-shell">
        <AdminNav active="settings" email={user.email} />

        <section className={`store-admin-main ${styles.main}`}>
          <div className={styles.page}>
            <div className={styles.pageHeader}>
              <div>
                ...
                <h1>Settings</h1>
                <p>
                  Update your business details, storefront defaults, payments,
                ...
                <div className={styles.settingsContent}>
                  <section id="business" className={styles.section}>
                    <div className={styles.sectionHeader}>
                      ...
                      <p>
                        Public-facing details used across your TCL storefront.
                      </p>
                    </div>
                  ...
                  <section id="store" className={styles.section}>
                    <div className={styles.sectionHeader}>
                      ...
                      <p>
                        Default values used when creating and processing orders.
                      </p>
                    </div>
                    ...
                    <div className={styles.fieldGrid}>
                      ...
                      <label className={styles.field}>
                        ...
                        <input
                          ...
                          step="0.01"
                          defaultValue={
                            settings.default_processing_fee_percent
                          }
                          required
                        />
                      </label>
                    ...
                    <div className={styles.toggleList}>
                      ...
                      <label className={styles.toggleRow}>
                        <div>
                          ...
                          <small>
                            Reserved for a future maintenance screen.
                          </small>
                        </div>
                        <input
                  ...
                  <section id="payments" className={styles.section}>
                    ...
                    <div className={styles.inlineNotice}>
                      These toggles are saved now. We can connect them to checkout
                      after the Settings UI is finalized.
                    </div>
                  </section>
                    ...
                    <div className={styles.fieldGridSingle}>
                      <label className={styles.field}>
                        ...
                        <input
                          ...
                          step="1"
                          defaultValue={
                            settings.download_link_expiry_minutes
                          }
                          required
                        />
                      </label>
                      ...
                      <label className={styles.field}>
                        ...
                        <textarea
                          ...
                          rows={5}
                          defaultValue={
                            settings.default_delivery_message ?? ""
                          }
                  ...
                  <section id="email" className={styles.section}>
                    <div className={styles.sectionHeader}>
                      ...
                      <p>
                        Prepared for your customer receipt and admin alert system.
                      </p>
                    </div>
                    ...
                    <div className={styles.toggleList}>
                      <label className={styles.toggleRow}>
                        <div>
                          ...
                          <small>
                            Use for automated payment confirmation emails.
                          </small>
                        </div>
                        <input
                          ...
                          type="checkbox"
                          defaultChecked={
                            settings.customer_payment_email_enabled
                          }
                        />
                      </label>
