...
export default async function CheckoutSuccessPage({
  ...
  if (receiptToken) {
    ...
    const { data: orderData, error } = await supabase
      .from("orders")
      .select(
        "id,order_number,customer_name,product_id,product_name,total_amount,currency,payment_status,order_status,paypal_order_id,paid_at,created_at,download_access_expires_at",
      )
